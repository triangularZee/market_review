...
- 코스피/코스닥 개인/기관/외국인 주체별 순매매대금.
- 개인/기관/외국인 주체별 순매수 TOP5와 순매도 TOP5는 원자료에 있을 때만 쓰세요. 없으면 "데이터 없음" 줄을 만들지 말고 생략하세요.
...
• 개인 순매수 TOP5: 종목(거래대금, 등락률), 종목(...), 종목(...). 순매도 TOP5: ...
• 기관 순매수 TOP5: ... / 외국인 순매수 TOP5: ...
