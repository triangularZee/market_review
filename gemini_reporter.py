...
주요 지수: 지수 등락률 | 지수 등락률
   CSI300 -0.1%, HSCEI +0.1%로 본토·홍콩 증시 혼조 
마감하며 AI 성장주 독주와 전통 경제 섹터 부진이 뚜렷한 K자형 
차별화 장세 연출. 
•   통신서비스(+4.00%) 섹터는 AI 데이터 트래픽 증가 수혜 
기대로 급등하며 시장을 주도, 반면 필수소비재(-1.13%), 
산업재(-1.26%) 등 내수 관련주는 약세를 보이며 경기 회복 
강도에 대한 신중한 시각 반영. 
•   인노라이트(+8.28%)와 캠브리콘(+6.49%)은 AI 수요 기반 
실적 성장으로 시장 상승을 견인, 하락은 전기차 시장 둔화 
우려의 CATL(-3.33%)과 신용 손실 충당금 증가 부담의 
중국농업은행(-0.44%) 주도. 
